...
* `main_with_syncpy` - project name - lowercase, no spaces, i.e. "snake_case" identifier - used as a package name, iOS/macOS/Android bundle name and Windows/Linux executable file name.
* `` - project description.
* `main_with_sync.py` - project display name that is shown in window titles and about app dialogs.
